...
public class JsonProducerPickupLocation {
    ...
    public JsonProducerPickupLocation() {
        ...
        props.put("sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required " +
                "username='NBOI7BRGWWU5XIWX' password='1eK6Ej6xzb31/kfGSOTE902MvdpBjj+zNyfeA7zs8NuLUChgu1U/wY/d1yvDPZ7G';");
    ...
    public void publish(PickupLocation pickupLocation) throws ExecutionException, InterruptedException {
        ...
        var record = kafkaProducer.send(new ProducerRecord<>("rides_location",
                String.valueOf(pickupLocation.PULocationID), pickupLocation), (metadata, exception) -> {
            if (exception != null) {
    ...
    public static void main(String[] args) throws IOException, CsvException, ExecutionException, InterruptedException {
        ...
        producer.publish(new PickupLocation(141, LocalDateTime.now()));
    }
}