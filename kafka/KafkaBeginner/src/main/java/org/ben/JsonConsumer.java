...
public class JsonConsumer {
    ...
    public JsonConsumer() {
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "pkc-ldvr1.asia-southeast1.gcp.confluent.cloud:9092");
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "benminh.v2");
